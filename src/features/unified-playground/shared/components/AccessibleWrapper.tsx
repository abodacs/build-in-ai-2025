...
export function AccessibleWrapper({
  ...
  useEffect(() => {
    ...
    if (enableKeyboardShortcuts) {
      ...
      accessibility.keyboardNavigation.registerShortcut(
        ...
        () => {
          ...
          accessibility.liveRegion.announce('Refreshing AI capabilities', 'polite')
        },
        true // Ctrl+R
      )
      ...
      accessibility.keyboardNavigation.registerShortcut(
        ...
        () => {
          ...
          accessibility.liveRegion.announce('Focused on configuration panel', 'polite')
        },
        false,
        true // Alt+C
      )
      ...
      accessibility.keyboardNavigation.registerShortcut(
        ...
        () => {
          ...
          accessibility.liveRegion.announce('Focused on output panel', 'polite')
        },
        false,
        true // Alt+O
      )
    ...
    return () => {
      // Cleanup shortcuts
      if (enableKeyboardShortcuts) {
        accessibility.keyboardNavigation.unregisterShortcut(KEYBOARD_SHORTCUTS.HELP)
  ...
  useEffect(() => {
    if (enableMotionReduction && accessibility.motionPreferences.prefersReducedMotion) {
  ...
  }, [enableMotionReduction, accessibility.motionPreferences.prefersReducedMotion])
