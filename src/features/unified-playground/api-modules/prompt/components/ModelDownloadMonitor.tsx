 ...
 *
 * @module prompt/components/ModelDownloadMonitor
 */
...
export function ModelDownloadMonitor({
  ...
  // Estimate model size (Chrome AI LanguageModel/Gemini Nano is ~22GB)
  const estimatedModelSize = '~22 GB';
          ...
          <div className="space-y-2">
            ...
            {downloadProgress.loaded && downloadProgress.total && (
              <p className="text-xs text-slate-500">
                {(downloadProgress.loaded / (1024 * 1024 * 1024)).toFixed(2)} GB
                / {(downloadProgress.total / (1024 * 1024 * 1024)).toFixed(2)}{' '}
                GB
              </p>
            )}
          </div>
