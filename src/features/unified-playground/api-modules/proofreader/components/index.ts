/**
 * Proofreader Components Exports
 *
 * @module proofreader/components
 */

export { ProofreaderConfig } from './ProofreaderConfig';
export { ProofreaderInput } from './ProofreaderInput';
export { ProofreaderResults } from './ProofreaderResults';
...
export type { ProofreaderResultsProps } from './ProofreaderResults';
