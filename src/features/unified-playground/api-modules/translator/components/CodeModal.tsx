              ...
              <AlertDescription>
                ...
                <CollapsibleContent className="mt-3 space-y-2 text-xs text-amber-800 dark:text-amber-200">
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      <strong>Chrome 138+</strong> with Chrome AI Translator API
                      enabled
                    </li>
                    <li>
                      Enable flag:{' '}
                    ...
                    <li>
                      Batch translation supports {advancedSettings.concurrency}x
                      parallel processing
                    </li>
                  </ul>
                </CollapsibleContent>
          ...
          <Tabs defaultValue="typescript" className="w-full">
            ...
            <TabsContent value="typescript" className="mt-0 space-y-3">
              <div className="text-sm text-slate-600 dark:text-slate-400">
                Full TypeScript implementation with types, examples, and batch
                translation
              </div>
